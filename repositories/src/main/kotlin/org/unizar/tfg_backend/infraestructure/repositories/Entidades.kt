...
class EntidadFormularioHumano(
        ...
        @SequenceGenerator(
                name = "form_humano_gen",
                sequenceName = "form_humano_seq",
                allocationSize = 1
        )
        @Column(name = "idform")
        val idForm: Int?,
        @Column(name = "edad") val edad: Short,
        @Column(name = "sexo") val sexo: Char,
        @Column(name = "fechacaso") val fechaCaso: LocalDate,
        @Column(name = "enfermedad") val enfermedad: String,
        @Column(name = "pais") val pais: String,
        @Column(name = "provinciaresidencia") val provinciaResidencia: Char,
        @Column(name = "municipioresidencia") val municipioResidencia: String,
        @Column(name = "defuncion") val defuncion: Boolean,
...
class EntidadFormularioMonitoreo(
        ...
        @Column(name = "idform")
        val idForm: Int?,
        @Column(name = "lugar") val lugar: String?,
        @Column(name = "vector") val vector: String,
        @Column(name = "enfermedad") val enfermedad: String?,
        @Column(name = "fecha") val fecha: LocalDate,
        @Column(name = "numero") val numero: Int,
...
class EntidadFormularioGarrapata(
        ...
        @SequenceGenerator(
                name = "form_garr_gen",
                sequenceName = "form_garr_seq",
                allocationSize = 1
        )
        @Column(name = "idform")
        val idForm: Int?,
        @Column(name = "municipiorecogida") val municipioRecogida: String,
...
class EntidadUsuario(
        ...
        @Column(name = "apellido1") val apellido1: String,
        @Column(name = "apellido2") val apellido2: String,
...
class EntidadRefreshToken(
        ...
        val id: Int?,
        @Column(name = "refresh_token") val token: String,
        @Column(name = "email") val emailUsuario: String
)
